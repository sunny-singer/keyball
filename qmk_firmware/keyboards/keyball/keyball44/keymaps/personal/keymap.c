...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [qwerty] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , _______  ,
               _______  , _______  , TT(navigation) , KC_SPC , TT(universal_mod) ,                 KC_BSPC , KC_ENT              , _______  , _______  , _______
  ),
  ...
  [gaming] = LAYOUT_universal(
    ...
    _______  , KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     ,                                 KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_ENT   ,
               _______  , _______  , _______  , KC_SPC   , TT(universal_mod) ,              KC_BSPC , KC_ENT              , _______  , _______  , TO(navigation)
  ),
  ...
  [navigation] = LAYOUT_universal(
    ...
    _______ , KC_LCTL , KC_LEFT , KC_DOWN , KC_RGHT , _______ ,                                       _______ , KC_RSFT , C(KC_C) , C(KC_V) , C(KC_X) , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ ,                                       _______ , SSNP_VRT, SSNP_HOR, SSNP_FRE, AML_TO  , _______ ,
              _______ , _______           , TG(navigation) , _______ , _______ ,            _______ , _______           , _______ , _______ , _______
  ),
  ...
  [universal_mod] = LAYOUT_universal(
    ...
    _______ , KC_6    , KC_7    , KC_8    , KC_9    , KC_0    ,                                       _______ , _______ , _______ , _______ , _______ , _______ ,
              _______ , _______           , _______ , _______ , TG(universal_mod) ,         _______ , _______           , _______ , _______ , _______
  ),

  [aml] = LAYOUT_universal(
    _______ , _______ , _______ , _______ , _______ , _______ ,                                       _______ , _______ , _______ , _______ , _______ , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ ,                                       _______ , KC_BTN1 , LT(scroll, KC_BTN3) , _______ , KC_BTN2 , _______ ,
    _______ , _______ , _______ , _______ , _______ , _______ ,                                       _______ , _______ , _______ , _______ , _______ , _______ ,
