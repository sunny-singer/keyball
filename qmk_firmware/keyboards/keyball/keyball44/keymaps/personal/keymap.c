...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [qwerty] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , _______  ,
               _______  , _______  , MO(navigation) , KC_SPC , MO(universal_mod) ,                 _______ , KC_ENT              , _______  , _______  , _______
  ),
  ...
  [gaming] = LAYOUT_universal(
    _______  , KC_ESC   , KC_Q     , KC_W     , KC_E     , KC_R     ,                                 KC_Y     , KC_U     , KC_I     , KC_O     , KC_P     , KC_BSPC  ,
    ...
    _______  , KC_LCTL  , KC_Z     , KC_X     , KC_C     , KC_V     ,                                 KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_ENT   ,
               _______  , _______  , _______  , KC_SPC   , MO(universal_mod) ,              _______ , KC_ENT              , _______  , _______  , TO(navigation)
  ),
